#!/usr/bin/env python3
"""Watch a Codex App Server JSONL event stream and notify Telegram."""
...
from telegram_notify import load_config, send_telegram
    ...
    def handle(self, message: dict[str, Any], now: float) -> list[str]:
        ...
        if method in INPUT_METHODS:
            ...
            if status == "completed":
                ...
                notifications.append("🟡 Codex interrupted\n\nThe active turn was interrupted.")
            else:
